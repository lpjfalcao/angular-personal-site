...
export class TimelineComponent {
  timelineItems: any[] = [
    ...
    {
      logo: 'assets/img/atsnet-logo.svg',
    ...
    {
      logo: 'assets/img/infobase-logo.png',
    ...
    {
      logo: 'assets/img/perlink-logo.png',
    ...
    {
      logo: 'assets/img/alterdata-logo.png',
